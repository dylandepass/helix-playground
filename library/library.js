...
`,zo=Object.defineProperty,Co=Object.getOwnPropertyDescriptor,te=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Co(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&zo(t,e,s),s};const ee=class extends Yt(P){constructor(){super(...arguments),this.value=void 0,this.selected=!1,this.expanded=!1}static get styles(){return[Qe]}get parentSideNav(){return this._parentSidenav||(this._parentSidenav=this.closest("sp-sidenav")),this._parentSidenav}get hasChildren(){return!!this.querySelector("sp-sidenav-item")}get depth(){let r=0,t=this.parentElement;for(;t instanceof ee;)r++,t=t.parentElement;return r}handleSideNavSelect(r){this.selected=r.target===this}handleClick(r){!this.href&&r&&r.preventDefault(),!this.disabled&&(!this.href||r!=null&&r.defaultPrevented)&&(this.hasChildren?this.expanded=!this.expanded:this.value&&this.announceSelected(this.value))}announceSelected(r){const t=new CustomEvent("sidenav-select",{bubbles:!0,composed:!0,detail:{value:r}});this.dispatchEvent(t)}click(){this.handleClick()}get focusElement(){return this.shadowRoot.querySelector("#item-link")}update(r){this.hasAttribute("slot")||(this.slot="descendant"),super.update(r)}render(){return u`
            <a
                href=${this.href||"#"}
                target=${h(this.target)}
                download=${h(this.download)}
...
`,Mo=Object.defineProperty,Bo=Object.getOwnPropertyDescriptor,oe=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Bo(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Mo(t,e,s),s};class ct extends function(t,e){var o;class a extends t{constructor(...c){super(c),this.slotHasContent=!1,new Ze(this,{config:{characterData:!0,subtree:!0},callback:i=>{for(const n of i)if(n.type==="characterData")return void this.manageTextObservedSlot()}})}manageTextObservedSlot(){if(!this[Qt])return;const c=[...this[Qt]].filter(i=>!!i.tagName||!!i.textContent&&i.textContent.trim());this.slotHasContent=c.length>0}update(c){if(!this.hasUpdated){const{childNodes:i}=this,n=[...i].filter(m=>m.tagName?e?m.getAttribute("slot")===e:!m.hasAttribute("slot"):!!m.textContent&&m.textContent.trim());this.slotHasContent=n.length>0}super.update(c)}firstUpdated(c){super.firstUpdated(c),this.updateComplete.then(()=>{this.manageTextObservedSlot()})}}return o=Qt,We([l({type:Boolean,attribute:!1})],a.prototype,"slotHasContent",2),We([Br(e,!0)],a.prototype,o,2),a}(Yt(P)){constructor(){super(),this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}static get styles(){return[qo]}get focusElement(){return this}get hasLabel(){return this.slotHasContent}get buttonContent(){return[u`
...
`;customElements.define("sp-icon-corner-triangle300",class extends C{render(){return W(u),(({width:r=24,height:t=24,title:e="Corner Triangle300"}={})=>Z`<svg
  ...
  >
    ...
    />
  </svg>`)()}});const U=function(r,...t){return ce?ce(r,...t):t.reduce((e,o,a)=>e+o+r[a+1],r[0])},O=r=>{ce=r};customElements.define("sp-icon-alert",class extends C{render(){return O(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Alert"}={})=>U`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
...
`,bs=Object.defineProperty,hs=Object.getOwnPropertyDescriptor;class ie extends at(T,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.vertical=!1}render(){return u``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}ie.styles=[gs],((r,t,e,o)=>{for(var a,s=o>1?void 0:o?hs(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&bs(t,e,s)})([l({type:Boolean,reflect:!0})],ie.prototype,"vertical",2),customElements.define("sp-divider",ie),customElements.define("sp-close-button",cr),customElements.define("sp-icon-info",class extends C{render(){return O(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Info"}={})=>U`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
...
`,fs=Object.defineProperty,ys=Object.getOwnPropertyDescriptor,le=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?ys(t,e):t,c=r.length-1;c>=0;c--)(a=r[c])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&fs(t,e,s),s};const xs=["negative","positive","info","error","warning"];class _t extends T{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[vs]}set timeout(t){const e=typeof t!==null&&t>0?Math.max(6e3,t):null,o=this.timeout;e&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=e,this.requestUpdate("timeout",o)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const e=this.variant;xs.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",e)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return u`
        ...
        `}updated(t){super.updated(t),t.has("open")&&(this.open?this.timeout&&this.startCountdown():this.timeout&&this.stopCountdown()),t.has("timeout")&&(this.timeout!==null&&this.open?this.startCountdown():this.stopCountdown())}}le([l({type:Boolean,reflect:!0})],_t.prototype,"open",2),le([l({type:Number})],_t.prototype,"timeout",1),le([l({type:String})],_t.prototype,"variant",1),customElements.define("sp-toast",_t);const ne=async(r,t,e,o)=>{const{Overlay:a}=await import("./overlay.js");return a.open(r,t,e,o)};var ks=d`
